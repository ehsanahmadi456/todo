...
function AboutPage() {
    return (
        <div>
            <p className="!text-dark-500 !text-4xl font-bold">About Us</p>
            ...
            <div className="flex items-center justify-start my-3 gap-4">
                ...
                />
                <div>
                    <Detail className="inline">Front End </Detail><Detail className="text-tertiary inline">Developer</Detail>
                </div>
            </div>
            ...
            <div>
                <Title className="!text-dark-500 mt-6 mb-3">Contact Us:</Title>
